...
if("FALSE" STREQUAL "TRUE")
  set(urdf_tutorial_SOURCE_PREFIX /tmp/buildd/ros-hydro-urdf-tutorial-0.2.3-0precise-20140617-0618)
  set(urdf_tutorial_DEVEL_PREFIX /tmp/buildd/ros-hydro-urdf-tutorial-0.2.3-0precise-20140617-0618/obj-x86_64-linux-gnu/devel)
  ...
  set(urdf_tutorial_INSTALL_PREFIX /opt/ros/hydro)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir}" STREQUAL "include")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'urdf_tutorial' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'Ioan Sucan <isucan@willowgarage.com>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'urdf_tutorial' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/opt/ros/hydro/${idir}'.  Ask the maintainer 'Ioan Sucan <isucan@willowgarage.com>' to fix it.")
    endif()
